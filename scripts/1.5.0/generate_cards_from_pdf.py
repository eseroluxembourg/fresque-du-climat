...
def extract(pdf_filename, force_ignore=False):
    ...
    output_dir = os.path.join('cards', language)
...
if __name__ == '__main__':
    ...
    if os.path.isdir(sys.argv[1]):
        ...
        for pdf in pdfs:
            ...
            extract(os.path.join(sys.argv[1], pdf), True)
            k += 1
    else:
        ...
        ['eu-ES', 'br-FR', 'br-FR', 'eu-ES', 'mk-MK', 'nb-NO', 'pt-BR', 'uk-UA', 'zh-CHT', 'he-IL', 'el-GR', 'mk-MK', 'et-EE', 'sl-SL', 'bg-BG', 'lt-LT', 'ca-ES', 'fi-FI', 'hr-HR', 'sq-AL', 'lv-LV', 'da-DK', 'sv-SE', 'lb-LU', 'uk-UA', 'zh-CHT', 'si-SL', 'ar-MA', 'lb-LU', 'sr-SP', 'sk-SK', 'et-EE', 'sl-SL', 'nl-BE', 'lv-LV', 'ro-RO', 'en-US', 'cs-CZ', 'ko-KR', 'sk-SK', 'sv-SE', 'fr-FR', 'fr-FR', 'el-GR', 'th-TH',
            'ru-RU', 'en-GB', 'pT-PT', 'th-TH', 'es-ES', 'sr-SP', 'ar-AR', 'pl-PL', 'mg-MG', 'en-GB', 'ru-RU', 'es-ES', 'oc-ES', 'oc-ES', 'pt-BR', 'ro-RO', 'lt-LT', 'ja-JP', 'en-US', 'tr-TR', 'hu-HU', 'ca-ES', 'bg-BG', 'ja-JP', 'ar-MA', 'de-DE', 'nl-BE', 'it-IT', 'ko-KR', 'cs-CZ', 'mg-MG', 'pT-PT', 'sq-AL', 'fi-FI', 'da-DK', 'he-IL', 'de-DE', 'tr-TR', 'ar-AR', 'pl-PL', 'hr-HR', 'hu-HU', 'it-IT', 'nb-NO', 'si-SL']
